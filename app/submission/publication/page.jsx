        ...
        <div>
            <TextSection title={"Publication & Indexing 2026"}>
                ...
                <div className='flex flex-col md:flex-row items-center justify-center gap-4'>
                    {/* <p>All ISET-2026 presented papers will be published in conference proceedings by Springer "Smart Innovation,Systems and Technologies" ISSN: 2190-3018, Book Series. ISSN: 2190-3018</p>
                    <img src="https://ISET.christuniversity.in/assets/images/springer.png" className='w-full max-w-xs md:max-w-sm' alt="Springer" /> */}
                    <div className='flex items-center justify-center py-12 w-full text-center text-2xl text-[#005B96] font-bold'>
